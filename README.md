...
| :--- | :--- | :--- | :--- |
| **Shaik Sumiya Zainab** | `teamLead` | Backend Architecture, FastAPI Orchestration, CI/CD Pipelines, System Integration | [@shaiksumiyazainab](https://github.com/shaiksumiyazainab) |
